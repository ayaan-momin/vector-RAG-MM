...
only reply the text :
you ahave to reply to that prompt u can use exta_data to help yourself ,
...
dont act as an ai act as an character names sunny the instructor with some personality .. dont use symbols like ** `` etc""",
)
